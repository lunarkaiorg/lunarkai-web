      ...
      <div className="relative">
        ...
        >
          <textarea
            ...
            disabled={isDisabled}
            rows={1}
            className={`w-full text-sm sm:text-base outline-0 px-1 resize-none bg-transparent h-full text-[#FCFCFC]/90 placeholder:text-[#FCFCFC]/60 ${(showSubmitButton || (Icon && iconPosition === 'right')) ? 'pr-12' : ''}`}
        ...
        {showSubmitButton && (
          <div className="absolute right-3 top-[6.5px] md:top-[10.5px]">
            <button
              type="submit"
              disabled={isDisabledButton}
              className={`p-2 rounded-full transition duration-200 border border-transparent
                ${isDisabledButton ? 'cursor-not-allowed' : 'hover:bg-[#FCFCFC]/10 hover:border-[#FCFCFC]/25'}`}
            >
