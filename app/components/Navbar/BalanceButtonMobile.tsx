...
const BalanceButtonMobile = ({ showLabel = false, onPopupOpen, className = '' }: BalanceButtonProps) => {
  ...
  return (
    <div className={`relative ${className}`} ref={buttonRef}>
      <motion.div
        ...
        className={`${baseButtonStyle} flex items-center select-none cursor-pointer overflow-hidden rounded-full h-[40px] ${
